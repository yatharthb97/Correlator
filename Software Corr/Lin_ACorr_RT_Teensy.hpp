 ...
 * @template Size of the Series and Channel array and indicates the maximum points that can be received by the correlator object. 
 * */
...
public:
  ...
  //counter_t Series_array[Series_size] = {0}; //! Stores the data points
