\hypertarget{discarder_8hpp}{}\section{lib/software/discarder.hpp File Reference}
\label{discarder_8hpp}\index{lib/software/discarder.\+hpp@{lib/software/discarder.\+hpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=264pt]{discarder_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=223pt]{discarder_8hpp__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
