...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{accumulator_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=250pt]{accumulator_8hpp__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
\begin{DoxyCompactItemize}
\item 
class \hyperlink{classAccumulator}{Accumulator$<$ Series\+\_\+size $>$}
