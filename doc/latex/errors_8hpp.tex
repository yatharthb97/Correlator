\hypertarget{errors_8hpp}{}\section{lib/hardware/errors.hpp File Reference}
\label{errors_8hpp}\index{lib/hardware/errors.\+hpp@{lib/hardware/errors.\+hpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=236pt]{errors_8hpp__incl}
\end{center}
\end{figure}
...
Yatharth Bhasin (github → yatharthb97) $\ast$\textbackslash{}
\end{DoxyAuthor}
/$\ast$$\ast$\+Enumarates the error codes thrown by the different modules. \begin{DoxyEnumFields}{Enumerator}
